    ...
    <el-col :lg="8" :md="12" class="right ">
      ...
      <el-form ref="formRef" :rules="rules" :model="form" class="w-[250px]">
        ...
        <el-form-item  prop="adminpwd">
          <el-input v-model="form.passward" placeholder="输入密码" type="password" show-password>
            <template #prefix>
        ...
        <el-form-item>
          <el-button type="primary" color="#60A5FA" round @click="onSubmit" :loading="loading" class="w-[250px] ">登录</el-button>
        </el-form-item>
      </el-form>
