    ...
    <el-col :span="24">
      <div class="search-bar">
        <el-select v-model="value" filterable remote clearable reserve-keyword
                   placeholder="Please enter keywords e.g. ZmDREB2.7"
                   :remote-method="remoteMethod" :loading="loading" class="w-full rounded-3xl"
                   @change="handleRemoteSearch" size="large">
