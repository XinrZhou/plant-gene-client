<template>
  ...
  <el-row class="flex justify-center">
    <el-col :lg="10" :md="24" :sm="20">
      <span class="bodyleft">{{ homeContentData.bodyContent }}</span>
    </el-col>
    <el-col :lg="14" :md="24" :sm="20" class="bodyright">
      <div>
        <el-carousel :interval="5000" arrow="always" style="width: 100%;  height: 400px;" arrow-class="my-arrow" autoplay>
